...
{	
	...
	/// </summary>
	public class SurviveItemPicker : MonoBehaviour 
	{
		...
		protected virtual void Initialization()
		{
			...
			if(usePosUi)
            {
				SurviveGUIManager.GetInstance().SetDisplayItem(this);
		...
		public virtual void Pick(string targetInventoryName, string playerID = "Player1")
		{
			...
			SurviveGUIManager.GetInstance().RemoveDisplayItem(this);

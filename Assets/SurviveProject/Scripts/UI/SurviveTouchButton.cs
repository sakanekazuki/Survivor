...
namespace MoreMountains.Tools
{
    ...
    [AddComponentMenu("Surivive/Tools/Controls/SurviveTouchButton")]
    public class SurviveTouchButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
    {
        [Header("Interaction")]
        ...
        public enum ButtonStates { Off, ButtonDown, ButtonPressed, ButtonUp, Disabled, MouseIn, MouseOut }
        [Header("Binding")]
        ...
        public Sprite MouseOutSprite;
        public Image MouseInImage;
        public Image MouseOutImage;

        [Header("Audio")]
        public AudioClip MouseInSe;
        public AudioClip MouseClickSe;
        public bool isSelectSfx = true;
        ...
        protected virtual void Update()
        {
            switch (CurrentState)
            {
                ...
                case ButtonStates.ButtonUp:
                    ...
                    break;
                case ButtonStates.MouseIn:

                    break;
                case ButtonStates.MouseOut:
        ...
        public virtual void OnPointerDown(PointerEventData data)
        {
            ...
            if (CurrentState != ButtonStates.Off && CurrentState!= ButtonStates.MouseIn)
            {
                return;
            }
        ...
        protected virtual void ResetButton()
        {
            ...
            OnPointerExit(new PointerEventData(EventSystem.current)); //マウス画像状態リセット
        }
        ...
        public virtual void OnPointerEnter(PointerEventData data)
        {
            ...
            //マウスオーバー音
            if(isSelectSfx) PlaySe(MouseInSe);
            isSelectSfx = true;
            ...
            {
                CurrentState = ButtonStates.MouseIn;
                if (MouseInSprite != null)
                {
                    if(_image == null) _image = GetComponent<Image>();
                    _image.sprite = MouseInSprite; 
                }
                else if (MouseInImage != null)
                {
                    MouseInImage.gameObject.SetActive(true);
                    MouseOutImage.gameObject.SetActive(false);
                }
            }
        }
        ...
        public virtual void OnPointerExit(PointerEventData data)
        {
            ...
            {
                CurrentState = ButtonStates.MouseOut;
                if (MouseOutSprite != null)
                {
                    _image.sprite = MouseOutSprite;
                }
                else if (MouseOutImage != null)
                {
                    MouseOutImage.gameObject.SetActive(true);
                    MouseInImage.gameObject.SetActive(false);
                }
            }
        }
        /// <summary>

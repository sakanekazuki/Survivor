...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Weapons/SurviveWeaponDash")]
	public class SurviveWeaponDash : SurviveWeaponBase, MMEventListener<TopDownEngineEvent>, MMEventListener<DashEvent>, MMEventListener<KillEvent>
	{
		...
		public override void SetParameter(AbilityData.WeaponLevelData data, GameDefine.StatusAttribute attribute, int id)
		{
			...
			{
				//バーストではないパターンはこれ系
				(this as SurviveWeaponDash).ProjectilesPerShot = currentData.Num + (Owner != null ? (Owner as SurvivePlayer).battleParameter.GetThrowNum(AbilityID) : 0);
			}

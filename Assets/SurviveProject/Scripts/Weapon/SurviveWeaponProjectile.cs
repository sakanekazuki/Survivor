...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Weapons/SurviveWeaponProjectile")]
	public class SurviveWeaponProjectile : SurviveWeaponBase, MMEventListener<TopDownEngineEvent>
	{

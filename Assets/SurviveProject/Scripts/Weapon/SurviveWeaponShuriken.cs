...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Weapons/SurviveWeaponShuriken")]
	//手裏剣　風魔手裏剣
	public class SurviveWeaponShuriken : SurviveWeaponBase, MMEventListener<TopDownEngineEvent>
	{
			...
			if (projectile != null)
			{
				...
				else
				{
					...
					else // if we're in 2D
					{
                        ...
                        //projectile.SetDirection(newDirection, newRotation, Owner.Orientation2D.IsFacingRight);
						//if (Owner.Orientation2D != null)
						//{

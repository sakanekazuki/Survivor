...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Weapons/SurviveWeaponSubBurn")]
	public class SurviveWeaponSubBurn : SurviveWeaponBase, MMEventListener<TopDownEngineEvent>, MMEventListener<MainWeaponShotEvent>
	{
		...
		public override void SetParameter(AbilityData.WeaponLevelData data, GameDefine.StatusAttribute attribute, int id)
		{
			...
			{
				//バーストではないパターンはこれ系
				(this as SurviveWeaponSubBurn).ProjectilesPerShot = currentData.Num + (Owner != null ? (Owner as SurvivePlayer).battleParameter.GetThrowNum(AbilityID) : 0);
			}
